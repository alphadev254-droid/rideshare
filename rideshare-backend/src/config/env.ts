...
const envSchema = z.object({
  ...
  PAYMENT_VERIFY_POLL_INTERVAL_SECONDS: z.coerce.number().default(15),
  PAYMENT_VERIFY_MAX_ATTEMPTS: z.coerce.number().default(40),
  PAYMENT_RESERVATION_TTL_MINUTES: z.coerce.number().default(10),
  PAYMENT_RESERVATION_SWEEP_SECONDS: z.coerce.number().default(60),
